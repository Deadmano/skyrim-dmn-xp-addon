...
; Spend XP on tagged skills.
		autoSpendXP(DMN_SXPAEH.DMN_SXPADebug, DMN_SXPAEH.DMN_SXPAExperiencePoints, DMN_SXPAEH.bUseExponentialSkillCost, DMN_SXPAEH.fSkillMultiplier, DMN_SXPAEH.fTaggedSkillsPriority, DMN_SXPAEH.iSkillXP, DMN_SXPAEH.iSkillXPSpent, DMN_SXPAEH.iSkillXPSpentEffective, DMN_SXPAEH.sSkillName, DMN_SXPAEH.sTaggedSkills)
		RegisterForSingleUpdate(1.0)
	EndIf
EndEvent
